...
def main() -> None:
    ...
    sft_config = SFTConfig(
        ...
        num_train_epochs=int(os.environ.get("DAVE_EPOCHS", "1")),
        ...
        weight_decay=0.0,
        bf16=True,
        # max_length 1024 fits ~99% of our pairs (avg completion is ~300 tokens).
        # packing concatenates short pairs up to max_length so the GPU isn't
        # spending 80% of each step on padding — biggest single win for short data.
        max_length=1024,
        packing=True,
        logging_steps=10,
        eval_strategy="steps",
